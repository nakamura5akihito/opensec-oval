...
import io.opensec.oval.repository.DefinitionsElementQueryParams;
import io.opensec.oval.repository.OvalResultsQueryParams;
import io.opensec.oval.repository.OvalSystemCharacteristicsQueryParams;
                                ...
                                )
                {
                    ...
                    if (_isList( value )) {
                        ...
                        for (int  i = 0; i < num_value_elem; i++) {
                            io.opensec.oval.model.results.DefinitionType  result_def =
                                            new io.opensec.oval.model.results.DefinitionType();
