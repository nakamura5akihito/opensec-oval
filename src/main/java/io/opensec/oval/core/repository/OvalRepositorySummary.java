...
import io.opensec.oval.model.results.DefinitionType;
import io.opensec.oval.model.results.OvalResults;
import io.opensec.oval.model.results.SystemType;
import io.opensec.oval.model.sc.InterfaceType;
import io.opensec.oval.model.sc.SystemInfoType;
        ...
        for (OvalResults  res : oval_results_list) {
            ...
            for (SystemType  sys : res.getResults().getSystem()) {
                ...
                for (DefinitionType  def_result : sys.getDefinitions().getDefinition()) {
                    io.opensec.oval.model.definitions.DefinitionType  def = null;
                    String  cve = null;
                    if (definitions == null) {
                    } else {
